            ...
            <DialogContent className="sm:max-w-[800px] bg-white">
                ...
                <div className="grid gap-4 py-1">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input type="name" placeholder="Enter Name" className="w-[500px]" />
                    </div>
                </div>
                <div className="grid gap-4 py-1">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input type="email" placeholder="Enter User Email" className="w-[500px]" />
                    </div>
                </div>
                <div className="grid gap-4 py-1">
                    <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid gap-4 py-1">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input type="email" placeholder="Enter Password" className="w-[500px]" />
                    </div>
                </div>
                <DialogFooter>
